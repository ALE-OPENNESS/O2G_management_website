...
@extends('layouts/master', ['title' => 'Delete User'])
...
<div id="login-page" class="row">
    <div class="col s12 z-depth-6 card-panel">
        ...
        <ul id="tabs-swipe" class="tabs">
            ...
            <li class="tab col s3"><a class="active teal-text" href="#deleteTab">Delete User</a></li>
...
<script>
    if ("<?php echo $_SESSION['header_delete'] ?>" != "") {
        setTimeout(function() { window.Materialize.toast("<?php echo $_SESSION['header_delete'] ?>", 5000) }, 500);
        <?php echo $_SESSION['header_delete'] = "" ;?>
    }
</script>
